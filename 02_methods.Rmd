...
Fishing (Figure \@ref(fig:mapfish)), oceanographic (Figure \@ref(fig:mapctd)) and plankton sampling (Figure \@ref(fig:mapplankton)) occurred offshore Triangle Island and in Queen Charlotte Sound, Hecate Strait, and Dixon Entrance. 
...
Vertical zooplanton tows were completed at all stations, however, two additional oblique plankton tows were completed at two offshore stations (CS01, T01). The vessel speed was controlled to allow a 45 degree wire angle to increase the volume of water sampled. Oblique plankton tows are a method under consideration for the 2022 Pan-Pacific High Seas Expedition.
