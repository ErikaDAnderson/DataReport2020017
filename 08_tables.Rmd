...
(ref:lwtable) Lengths and weights for each species (arranged descending by the number of tows for each by species) sampled during the `r surveyName` aboard the `r vessel`, `r surveyDateRange`. (Tows = number of tows, Measured = number of lengths, Weighed = number of weights).
...
(ref:preytable) Prey items (Prey) identified in the stomach contents of species sampled (list alphabetically by Species) during during the `r surveyName` aboard the `r vessel`, `r surveyDateRange`. Volume is averaged in cm^3^; Count is the number of stomachs observed with each prey.
