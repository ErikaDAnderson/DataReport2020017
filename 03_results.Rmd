...
This survey completed `r offshoretows` offshore mid water trawls for gear setup and `r coastaltows` coastal mid water trawls (Appendix \@ref(app:appBridge)). Although all net adjustment tows were done with the codend open to avoid the capture of fish, a 4.6 m Common Thresher Shark (*Alopias vulpinus*) was captured, and released alive from the first tow (Figure \@ref(fig:sharkphoto)). The last coastal mid water trawl of the survey tow was aborted in Queen Charlotte Strait due to equipment failure of the third wire winch. Subsequent tows were cancelled.
...
In preparation for the 2022 Pan-Pacific High Seas Expedition, three MOCNESS and two oblique bongo tows were completed. Both techniques were deployed under calm sea conditions off the *`r vessel`*. The MOCNESS did not close nets between all depth strata in 2 of the 3 tows. 
