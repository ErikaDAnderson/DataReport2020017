...
This survey completed `r offshoretows` offshore LFS 1142 trawl net tows for gear setup and `r coastaltows` coastal LFS 7742 trawl net tows (Appendix \@ref(app:appBridge)). Although all offshore LFS 1142 trawl net adjustment tows were done with the codend open to avoid the capture of fish, a 4.6 m Common Thresher Shark (*Alopias vulpinus*) was captured, and released alive from the first tow (Figure \@ref(fig:sharkphoto)). The last coastal LFS 7742 trawl net tow of the survey was aborted in Queen Charlotte Strait due to equipment failure of the third wire winch. Subsequent tows were cancelled.
