...
select(Event, Date, TrawlNet, StartTime, DURATION, START_LAT, START_LONG, END_LAT, END_LONG, HEADING, SPEED_KM, DISTANCE_KM, VerticalNetOpening, Wingspread, Warp, Doorspread, TargetHeadDepth, ActualHeadDepth, Start_Bot_Depth, StopBotDepth, Usable) %>%
    dplyr::rename(
      "Event Number" = Event,
      "Trawl Net" = TrawlNet,
...
# date, start time, bottom depth, gear depth for CTD, Bongo Vert, Bongo Oblique, MOCNESS
