...
abstract: |
  Fisheries and Oceans Canada conducted an ecosystem-based survey from October 6-16, 2020 on the *CCGS Sir John Franklin*. This study targeted juvenile salmon from Queen Charlotte Sound to Dixon Entrance. The survey was designed to determine the distribution, abundance, and ecology of juvenile Pacific salmon (*Oncorhynchus* spp.) on the north coast of British Columbia. 
  
  There were 26 species sampled in 1741 kg of catch, with 25% salmon caught by weight. Overall opalescent inshore squid and moon jellies were the most abundant species. Lengths and weights were recorded for 17 species, including all 5 salmon species. Juvenile chum salmon were the most abundant salmon species with large catches, particularly in Hecate Strait, and only 2% containing empty stomachs. Pink salmon were the most widespread species, whereas juvenile sockeye salmon were localized in northern Dixon Entrance. Both juvenile pink and sockeye salmon were primarily feeding on euphausiids and amphipods. Juvenile coho salmon were less abundant and were caught in Dixon Entrance and Hecate Strait, to a lesser amount. Juvenile coho had 47% empty stomachs and the widest variety of prey in their stomach contents. Only three chinook salmon were caught. The only chinook salmon with stomach contents contained squid. 
  
  Biological samples for genetic stock composition and energy density are at the Pacific Biological Station for laboratory analysis. Associated information on the physical oceanography and plankton composition was collected from 21 stations, and will be analysed at the Institute for Ocean Sciences. As it becomes available, laboratory analyses will be integrated with the catch and salmon data.  

  In addition, gear optimization occurred for the 2022 Pan-Pacific High Seas Expedition. The protocols for the offshore LFS 1142 trawl net, MOCNESS (Multiple Opening and Closing Net with Environmental Sensing System), oblique plankton tows, and rosette deployment using the LARS winch system were tested.
abstract_other: |
  Voici le résumé.
output:
